...
<section id="<?= esc_attr($id) ?>" class="<?= esc_attr($className) ?>">
    <div class="content-wrapper">
        <svg class="about-us-top-svg" width="1728" height="56" viewBox="0 0 1728 56" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <svg class="about-us-bottom-svg" width="415" height="520" viewBox="0 0 415 520" fill="none" xmlns="http://www.w3.org/2000/svg">
